...
wstring XmlEncode(const wstring& input, const EncodingOptions& options)
{
    static pair<wchar_t, UnicodeNameInfo> gUnicodeNameArray[] =
    {
    ...
    static wishful_hash_map<wchar_t, UnicodeNameInfo> gUnicodeNameTable(gUnicodeNameArray, END_ARRAY(gUnicodeNameArray));
